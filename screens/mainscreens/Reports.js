    ...
    return (
        <SafeAreaView style={{padding: 16}}>
            <ScrollView>
                ...
                <Button mb={6} onPress={() => navigation.navigate("LeastProductsThatMadeProfit")}>Least products that made profit</Button>
                <Divider mb={6}/>
                <Button mb={4} onPress={() => navigation.navigate("Profits")}>Profits</Button>
            </ScrollView>
        </SafeAreaView>
    );
};
