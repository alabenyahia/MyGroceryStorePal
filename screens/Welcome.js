...
const Welcome = ({navigation}) => {
    return (
        <SafeAreaView style={{backgroundColor: "#F16B44", flex: 1, padding: 16}}>
            ...
            <Pressable style={{backgroundColor: "#F3F4F6", borderRadius: 4,
                paddingVertical: 16, marginBottom: 12}} onPress={() => navigation.navigate("Login")}>
                <Text style={{color: "#F16B44", textAlign: "center"}}>LOGIN</Text>
            </Pressable>

            <Pressable style={{backgroundColor: "transparent", borderRadius: 4,
